...
const (
	...
	msgTriggerList          = "Вывести список текущих ключевых слов"
	msgTriggerCreate        = "Добавить ключевое слово"
	...
	msgCancel               = "Отменить"
	msgCanceled             = "Отменено ❗️"
	msgEmpty                = "Пусто ❗️"
	msgDelete               = "Удалить ❌"
	msgDeleteSuccess        = "Удаление прошло успешно"
	msgDeleteReply          = "⚠️ Вы были исключены из списка администраторов"
